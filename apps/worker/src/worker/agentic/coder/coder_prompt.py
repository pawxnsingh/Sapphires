...
async def systemPrompt(projectType: Literal["NEXTJS", "REACT_NATIVE", "REACT"]) -> str:
  ...
  {NEXT_JS_ARTIFACT_INFO if projectType == "NEXTJS" else (REACT_NATIVE_ARTIFACT_INFO if projectType == "REACT_NATIVE" else REACT_ARTIFACT_INFO)}
  """
